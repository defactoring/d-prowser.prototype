 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class np{constructor(){this.changes=new tn(e=>e.toString(),(e,t)=>e.isEqual(t)),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,t){this.assertNotApplied(),this.changes.set(e,ek.newInvalidDocument(e).setReadTime(t))}getEntry(e,t){this.assertNotApplied();let n=this.changes.get(t);return void 0!==n?K.resolve(n):this.getFromCache(e,t)}getEntries(e,t){return this.getAllFromCache(e,t)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nk{constructor(e,t,n,r){this.targetId=e,this.fromCache=t,this.Vi=n,this.Si=r}static Di(e,t){let n=th(),r=th();for(let e of t.docChanges)switch(e.type){case 0:n=n.add(e.doc.key);break;case 1:r=r.add(e.doc.key)}return new nk(e,t.fromCache,n,r)}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function(e){if("L"===e.limitType&&0===e.explicitOrderBy.length)throw new T(E.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}(e._query),(function(e,t,n={}){let r=new I;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,s){let i=new r1({next:n=>{t.enqueueAndForget(()=>r_(e,a)),n.fromCache&&"server"===r.source?s.reject(new T(E.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):s.resolve(n)},error:e=>s.reject(e)}),a=new rD(n,i,{includeMetadataChanges:!0,xu:!0});return rC(e,a)})(await r6(e),e.asyncQueue,t,n,r)),r.promise})(n,e._query).then(n=>new sJ(t,r,e,n)))}function s1(e,t,n){var r;e=sr(e,sa);let s=sr(e.firestore,sd),i=(r=e.converter)?n&&(n.merge||n.mergeFields)?r.toFirestore(t,n):r.toFirestore(t):t;return s3(s,[(function(e,t,n,r,s,i={}){let a,o;let l=e.ua(i.merge||i.mergeFields?2:0,t,n,s);sR("Data must be an object, but it was:",l,r);let u=sk(r,l);if(i.merge)a=new en(l.fieldMask),o=l.fieldTransforms;else if(i.mergeFields){let e=[];for(let r of i.mergeFields){let s=sL(t,r,n);if(!l.contains(s))throw new T(E.INVALID_ARGUMENT,`Field '${s}' is specified in your field mask but missing from your input data.`);sF(e,s)||e.push(s)}a=new en(e),o=l.fieldTransforms.filter(e=>a.covers(e.field))}else a=null,o=l.fieldTransforms;return new sT(new eD(u),a,o)})(sA(s),"setDoc",e._key,i,null!==e.converter,n).toMutation(e._key,tS.none())])}function s2(e,t,n,...r){let s;e=sr(e,sa);let i=sr(e.firestore,sd),a=sA(i);return s="string"==typeof(t=(0,l.m9)(t))||t instanceof sy?function(e,t,n,r,s,i){let a=e.ua(1,t,n),o=[sL(t,r,n)],u=[s];if(i.length%2!=0)throw new T(E.INVALID_ARGUMENT,`Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let e=0;e<i.length;e+=2)o.push(sL(t,i[e])),u.push(i[e+1]);let h=[],c=eD.empty();for(let e=o.length-1;e>=0;--e)if(!sF(h,o[e])){let t=o[e],n=u[e];n=(0,l.m9)(n);let r=a.na(t);if(n instanceof sN)h.push(t);else{let e=sD(n,r);null!=e&&(h.push(t),c.set(t,e))}}let d=new en(h);return new sI(c,d,a.fieldTransforms)}(a,"updateDoc",e._key,t,n,r):function(e,t,n,r){let s=e.ua(1,t,n);sR("Data must be an object, but it was:",s,r);let i=[],a=eD.empty();H(r,(e,r)=>{let o=sV(t,e,n);r=(0,l.m9)(r);let u=s.na(o);if(r instanceof sN)i.push(o);else{let e=sD(r,u);null!=e&&(i.push(o),a.set(o,e))}});let o=new en(i);return new sI(a,o,s.fieldTransforms)}(a,"updateDoc",e._key,t),s3(i,[s.toMutation(e._key,tS.exists(!0))])}function s4(e){return s3(sr(e.firestore,sd),[new tF(e._key,tS.none())])}function s3(e,t){return function(e,t){let n=new I;return e.asyncQueue.enqueueAndForget(async()=>rP(await r5(e).then(e=>e.syncEngine),t,n)),n.promise}(sm(e),t)}!function(e,t=!0){d=i.SDK_VERSION,(0,i._registerComponent)(new a.wA("firestore",(e,{instanceIdentifier:n,options:r})=>{let s=e.getProvider("app").getImmediate(),i=new sd(new A(e.getProvider("auth-internal")),new b(e.getProvider("app-check-internal")),function(e,t){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new T(E.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new ed(e.options.projectId,t)}(s,n),s);return r=Object.assign({useFetchStreams:t},r),i._setSettings(r),i},"PUBLIC").setMultipleInstances(!0)),(0,i.registerVersion)(h,"3.10.0",void 0),(0,i.registerVersion)(h,"3.10.0","esm2017")}()}}]);